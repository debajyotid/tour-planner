...
def render_input_form():
    ...
    return submitted, destination, no_of_adults, no_of_children, start_date, end_date, budget, interests
...
def generate_itinerary(destination, no_of_adults, no_of_children, start_date, end_date, budget, interests, location, openaiclient, gmapsclient, openweather_api_key):
